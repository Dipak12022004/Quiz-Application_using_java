...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        Image i = i1.getImage().getScaledInstance(1200, 350, Image.SCALE_SMOOTH); 
        ...
        next = createButton("Next", 700, 650);
        add(next);

        lifeline = createButton("50-50 Help", 880, 650);
        add(lifeline);

        submit = createButton("Submit", 1040, 650);
    ...
    private void setupQuestions() {
        ...
        questions[2][0] = "In which case automatic type conversion is not possible?";
    ...
    public void paint(Graphics g) {
        ...
        if (timer > 0) {
            g.drawString(time, 1000, 435);
        } else {
            g.drawString("Time's Up!", 1000, 435);
        }
